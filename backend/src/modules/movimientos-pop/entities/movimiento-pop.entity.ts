...
export type MovimientoTipo   = 'salida' | 'entrada' | 'devolucion' | 'consumo' | 'merma';
export type MovimientoEstado = 'en_terreno' | 'devuelto_completo' | 'devuelto_parcial' | 'consumido' | 'merma';
